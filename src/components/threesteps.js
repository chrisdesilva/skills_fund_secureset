    ...
    return (
        <div className="p-4" ref={ref}>
            ...
            <div className="flex flex-col lg:flex-row justify-center text-center">
                ...
                <div id="stepCard1" className="stepCards flex flex-col items-center m-2 lg:w-1/3 p-4 rounded shadow-2xl bg-white border-secondary border-t-8">
                ...
                <div id="stepCard2" className="stepCards flex flex-col items-center m-2 lg:w-1/3 p-4 rounded shadow-2xl bg-white border-secondary border-t-8">
                ...
                <div id="stepCard3" className="stepCards flex flex-col items-center m-2 lg:w-1/3 p-4 rounded shadow-2xl bg-white border-secondary border-t-8">
