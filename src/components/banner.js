...
const Banner = props => (
    <div>
        <div className="h-64 py-48 text-white flex flex-col justify-center items-center relative z-0" id="banner">
            {/* update h2 with school-specific content */}
            <h2 className="text-3xl lg:text-4xl font-normal text-center mt-8 text-white">Learn Cybersecurity at SecureSet</h2>
            <h3 className="text-base lg:text-xl font-light text-center text-white">Know exactly what you'll pay with Skills Fund</h3>
