        ...
        <div className="p-0 md:p-4 lg:hidden">
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        <td className="text-center font-bold bg-gray-100">Interest-Only Monthly Payment</td>
                    </tr>
                    <tr>
                        <td className="text-center">{props.ioPayment36} (4)</td> 
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td className="text-center">{props.ioPayment60} (5)</td> 
                    </tr>
                    <tr>
                        <td className="text-center font-bold bg-gray-100">Full Monthly (Principal and Interest) Payment</td>
                    </tr>
...
export default InterestOnlyTerms